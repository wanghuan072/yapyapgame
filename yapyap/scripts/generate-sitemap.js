...
const baseRoutes = [
  ...
  { path: '/puzzle/ball-puzzle', name: 'ball-puzzle', priority: 0.8, changefreq: 'monthly' },
  { path: '/puzzle/balance-puzzle', name: 'balance-puzzle', priority: 0.8, changefreq: 'monthly' },
  { path: '/puzzle/door-puzzle', name: 'door-puzzle', priority: 0.8, changefreq: 'monthly' },
  { path: '/guide/overview', name: 'guides', priority: 0.9, changefreq: 'weekly' },
