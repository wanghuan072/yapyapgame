export const guides = [
  ...
  <div class="yapyap-guide-container">
      ...
      <div class="secret-box">
          ...
          <p style="margin: 1em 0px;">This is the biggest secret in the demo. Don't just loot the chest—<strong>destroy it!</strong></p>
      ...
      <div class="flight-box">
          <h3 style="font-size: 1.17em; font-weight: bold;">🚀 How to Fly Higher (Combo Guide)</h3>
